...
namespace CaptureTool
{
    public partial class ColorSelector : UserControl
    {
        ...
        {
            add { Events.AddHandler(EventFontSizeChanged, value); }
            remove { Events.RemoveHandler(EventFontSizeChanged, value); }
        }
        ...
        {
            EventHandler handler = Events[EventColorChanged] as EventHandler;
            if (handler != null)
            {
                handler(this, e);
            }
        ...
        {
            EventHandler handler = Events[EventFontSizeChanged] as EventHandler;
            if (handler != null)
            {
                handler(this, e);
            }
        ...
        private void ColorLabelClick(object sender, EventArgs e)
        {
            ...
            if (control != null) colorLabelSelected.BackColor = control.BackColor;
            OnColorChanged(e);
        }
