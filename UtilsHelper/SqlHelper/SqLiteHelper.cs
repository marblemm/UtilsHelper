...
namespace UtilsHelper.SqlHelper
{
    ...
    public class SqLiteHelper
    {
        ...
        public static int ExecuteNonQuery(IDbConnection cn, string commandText, params object[] paramList)
        {
            var sqliteConn = cn as SQLiteConnection;
            if (sqliteConn == null) return 0;
